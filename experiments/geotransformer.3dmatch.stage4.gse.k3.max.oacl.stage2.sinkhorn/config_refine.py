...
_C.output_dir = osp.join(_C.root_dir, 'output2', _C.exp_name)
_C.snapshot_dir = osp.join(_C.output_dir, 'snapshots2')
_C.log_dir = osp.join(_C.output_dir, 'logs2')
_C.event_dir = osp.join(_C.output_dir, 'events2')
_C.feature_dir = osp.join(_C.output_dir, 'features2')
_C.registration_dir = osp.join(_C.output_dir, 'registration2')
...
# --------------------------
# model - OmniGlue Refiner config 추가
# --------------------------
_C.model.name = 'omniglue'                   # just for interfacing
_C.model.descriptor_dim = 256
_C.model.lr = 16e-5
_C.model.refiner_num_heads = 1
_C.model.refiner_n_layers = 4
_C.model.refiner_descriptor_dim = 64
_C.model.glue_detach = True
_C.model.glue_refine = True
_C.model.flash = True
_C.model.fine_loss_use_mnn = True
_C.model.iter_size = 4
_C.model.low_overlap = True
_C.model.use_color = False
